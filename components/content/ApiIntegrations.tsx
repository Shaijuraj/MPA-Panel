        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card title="Your API Keys">
                    <p className="text-gray-700 dark:text-gray-300 mb-4">Manage API keys for integrating with external services.</p>
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
                            <div>
                                <p className="font-mono text-sm">prod_sk_****...**vG4</p>
                                <p className="text-xs text-gray-600 dark:text-gray-400">Full access, created on 2023-05-10</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
                            <div>
                                ...
                                <p className="text-xs text-gray-600 dark:text-gray-400">Read-only, created on 2023-02-01</p>
                            </div>
                            <button className="text-sm text-red-500 hover:text-red-700">Revoke</button>
                        </div>
                    </div>
                ...
                <Card title="Webhooks">
                    <p className="text-gray-700 dark:text-gray-300 mb-4">Configure webhooks to receive real-time notifications.</p>
                     <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-md">
                            <div>
                                <p className="font-mono text-sm">https://api.example.com/webhooks/users</p>
                                <p className="text-xs text-gray-600 dark:text-gray-400">Events: user.created, user.updated</p>
                            </div>
